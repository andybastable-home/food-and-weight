...
## Current phase
**Phase 9 🚧 — Weekly Goal: pace tile + weekly deficit chart** (v0.15.1; coded, pending verification on phone).
...
1. Version `v0.15.1` shown in brand header and footer.
...
- Service worker cache: `fw-shell-v0.15.1`.
